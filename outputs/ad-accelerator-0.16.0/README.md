# Ad Accelerator 0.16.0 — Chrome Web Store release candidate

Version 0.16.0 keeps the 0.15.0 runtime unchanged and refreshes the extension description, packaged help, privacy policy, credits, website copy, supported-player page, search metadata, store listing and reviewer materials. Named on-demand integrations are Prime Video, JioHotstar, YouTube, Plex, Amazon MX Player, ZEE5, SonyLIV and WeTV. The generic HTML5 transition detector remains broader experimental coverage, not a universal compatibility claim.
